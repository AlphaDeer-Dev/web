...
import { ButtonHTMLAttributes, DetailedHTMLProps, DO_NOT_USE_OR_YOU_WILL_BE_FIRED_CALLBACK_REF_RETURN_VALUES, JSXElementConstructor, ReactElement, ReactNode, ReactPortal, RefObject, useState } from "react";
        ...
        <>
            <div style={{
                ...
                <div style={{
                    ...
                    <Button appearance="subtle" size="large" shape="square" onClick={() => { props.setRoute("/") }}>AlphaDeer</Button>
                </div>
                <div style={{
                    flex: 1,
                    textAlign: "center"
            ...
            <div style={{
                ...
                <SideNav onClick={() => { props.setRoute("/test") }}>Test</SideNav>
            </div>
        </>
    )
}